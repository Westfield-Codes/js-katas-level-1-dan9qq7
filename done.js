...
var favice = prompt("what is your favorite ice cream flavor?");
// make an integer variable for number of scoops on the cone, prompt user for it
var scoops = prompt("number of scoops of that flavor that you prefer?");
// alert "You want " scoops "scoops of " flavor
alert("You want " + scoops + " scoops of " + favice);
